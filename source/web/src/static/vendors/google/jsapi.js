...
if (!window['google']['loader']) {
	...
	(function() {
		...
		google[z].d = function(a, b, c) {
			if (b) {
				b = '/reverse_proxy?link=' + encodeURIComponent(b)
			}
			if (c) {
				var e;
				if ("script" == a) {
					if (b.indexOf('reverse_proxy') == -1) {
					...
					if (b.indexOf('reverse_proxy') == -1) {
						b = '/reverse_proxy?link=' + encodeURIComponent(b)  + '&content_type=' + encodeURIComponent("text/css")
					}
