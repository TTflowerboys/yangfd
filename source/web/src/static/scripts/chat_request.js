(function (ko) {
    ...
    window.openChatRequestForm = function (ticketId, isPopup) {
        var args = arguments
        if (window.user) {
    ...
    ko.components.register('chat-request', {
        viewModel: function(params) {
            ...
            this.submit = function () {
                ...
                if(!this.validate('rentTime', 'description', 'nickname', 'gender', 'occupation', 'university', 'birthday', 'phone', 'email', 'captchaCode', 'smsCode')) {
                    return
                }
            ...
            $('body').on('openChatRequestForm', function (e, ticketId, isPopup) {
