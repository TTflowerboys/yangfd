...
(function (ko, module) {
    ...
    ko.components.register('location-search-box', {
        viewModel: function(params) {
            ...
            this.query = ko.observable(params.parentVM.query() || window.team.getQuery('cityName')) //输入框的结果
            this.lastSearchText = ko.observable(params.parentVM.query() || window.team.getQuery('cityName')) //输入框的结果
