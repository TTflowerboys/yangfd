    ...
    function RentListViewModel() {
        ...
        this.paramsToWrite = ko.computed({
            ...
            write: function (value) {
                var whiteList = ['rent_available_time', 'rent_deadline_time', 'rent_type', 'rent_budget_min', 'rent_budget_max', 'property_type', 'bedroom_count', 'space', 'query', 'cityName'].concat(module.suggestionTypeSlugList)
                var suggestionParams = {}
                _.each(module.suggestionTypeSlugList, function (slug) {
                    suggestionParams[slug] = ''
                })
                var pureValue = _.extend(suggestionParams, {cityName: ''},  _.pick(value, whiteList))
