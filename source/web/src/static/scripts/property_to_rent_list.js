    ...
    function RentListViewModel() {
        ...
        this.paramsToWrite = ko.computed({
            ...
            write: function (value) {
                var whiteList = ['rent_available_time', 'rent_deadline_time', 'rent_type', 'rent_budget_min', 'rent_budget_max', 'property_type', 'bedroom_count', 'space', 'query'].concat(module.suggestionTypeList)
        ...
        this.searchTicket = function () {
            this.query(this.queryTemp() || this.query())
            module.loadRentListByView()
        }
