...
describe(@"share text and url", ^{
    it(@"should success", ^{
        ...
        [[CUTEShareManager sharedInstance] shareText:@"Share Test" description:@"" urlString:@"http://www.baidu.com" imageUrl:@"https://devimages.apple.com.edgekey.net/assets/elements/icons/128x128/os-x-10-11-white.png" wechatUrl:nil inServices:@[CUTEShareServiceWechatCircle, CUTEShareServiceSinaWeibo] viewController:webViewController onButtonPressBlock:^(NSString *buttonName) {
