...
if [ "${HTTP_STATUS}" = "200" ] ; then
    echo "Upload OK"
	curl -X POST --data-urlencode 'payload={"channel": "#publish", "username": "pgyer.com", "text": "New Build Update. Download http://www.pgyer.com/BVzn", "icon_emoji": ":ghost:"}' https://hooks.slack.com/services/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
