...
- (NSArray *)fields {
    return @[
             ...
             @{FXFormFieldKey: @"submit", FXFormFieldCell: [CUTEFormButtonCell class], FXFormFieldTitle:STR(@"PropertyInfo/预览并发布"), FXFormFieldHeader: @"", FXFormFieldAction: @"submit", FXFormFieldFooter:STR(@"PropertyInfo/发布则表示您已经阅读并同意洋房东服务须知")},
             ];
}
