...
- (NSArray *)fields {
    return @[
             ...
             @{FXFormFieldKey: @"rooms", FXFormFieldTitle:STR(@"房屋户型（可选Studio）"), FXFormFieldCell: [CUTEFormRoomsPickerCell class], @"style": @(UITableViewCellStyleValue1), FXFormFieldAction: @"editRooms:"},
