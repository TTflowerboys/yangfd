...
class CUTESingleRoomPreferenceForm: CUTETicketForm {
    ...
    override func fields() -> [AnyObject]! {
        return [[FXFormFieldKey:"genderRequirement", FXFormFieldTitle:STR("SingleRoomPreference/入住性别要求"), FXFormFieldHeader:STR("SingleRoomPreference/入住者要求")],
            ...
            [FXFormFieldKey:"currentMaleRoommates", FXFormFieldTitle:STR("SingleRoomPreference/当前男室友的数量"), FXFormFieldHeader:STR("SingleRoomPreference/目前室友")],
            [FXFormFieldKey:"currentFemaleRoommates", FXFormFieldTitle:STR("SingleRoomPreference/当前女室友的数量")],
            [FXFormFieldKey:"availableRooms", FXFormFieldTitle:STR("SingleRoomPreference/可入住新室友")],
