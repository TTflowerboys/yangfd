...
- (NSArray *)fields {
    return @[
             ...
             @{FXFormFieldKey: @"hodingDeposit", FXFormFieldTitle:STR(@"PropertyMoreInfo/定金"), FXFormFieldType:FXFormFieldTypeFloat, FXFormFieldCell: [CUTEFormCurrencyTextFieldCell class], @"textField.keyboardType": @(UIKeyboardTypeDecimalPad), FXFormFieldAction: @"onHoldingDepositEdit:", FXFormFieldValueTransformer: [CUTEPlainTextNumberTransformer class]},
