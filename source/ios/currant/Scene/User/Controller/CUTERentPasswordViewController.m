...
- (void)onVerificationButtonPressed:(id)sender {
    ...
    [[[CUTEAPIManager sharedInstance] POST:@"/api/1/user/sms_verification/send" parameters:@{@"phone":phone, @"country":country.ISOcountryCode} resultClass:nil] continueWithBlock:^id(BFTask *task) {
        if (task.error) {
