...
- (void)onCheckUpdatePressed:(id)sender {
    ...
    NSURLRequest *request = [[CUTEAPIManager sharedInstance] requestWithMethod:@"GET" URLString:[NSURL URLWithString:checkUrl relativeToURL:[NSURL URLWithString:[CUTEConfiguration apiEndpoint]]].absoluteString parameters:checkParams error:nil];
