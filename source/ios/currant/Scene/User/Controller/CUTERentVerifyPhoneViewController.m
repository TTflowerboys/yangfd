...
- (void)onVerificationButtonPressed:(id)sender {
    ...
    [[[CUTEAPIManager sharedInstance] POST:@"/api/1/user/sms_verification/send" parameters:@{@"phone": CONCAT(NilNullToEmpty(form.user.countryCode), NilNullToEmpty(form.user.phone))} resultClass:nil] continueWithBlock:^id(BFTask *task) {
