...
class common(f_common):
    ...
    user_custom_fields = ["email", "register_time", "phone", "city", "country", "state", "zipcode", "gender", "date_of_birth", "intention", "wechat_id", "counter", "system_message_type", "email_message_type", "locales", "currency", "budget", "is_vip", "state", "address1", "address2", "occupation", "status"]
