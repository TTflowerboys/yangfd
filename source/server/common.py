...
class common(f_common):
    ...
    user_custom_fields = ["email", "register_time", "phone", "city", "country", "state", "zipcode", "gender", "date_of_birth", "intention", "counter", "system_message_type", "email_message_type", "locales", "currencies", "budget", "is_vip", "state", "address1", "address2", "occupation", "status", "wechat", "private_contact_methods", "user_type", "referral"]
