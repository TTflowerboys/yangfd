...
class common(f_common):
    ...
    # i18n_locales = ["en_GB", "zh_Hans_CN", "zh_Hant_HK"]
    i18n_locales = ["en_GB", "zh_Hans_CN"]
    i18n_currencies = ["CNY", "GBP", "USD", "HKD"]
    i18n_additional_param_locales = ["zh_Hant_HK"]
    ...
    sms_verification_provider_smart = {
        "call": {"default": {"method": "sinch"}},
        "sms": {"default": {"method": "simple"}},
    }
